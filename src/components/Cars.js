        ...
        <div className="cars-page-container">
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="cars-page-carousel carousel-item active">
                        <img src="g82-m4-santorini-blue.jpeg" class="d-block w-100 img-fluid" alt="BMW M Trio Banner" id="carousel-image"/>
                    ...
                    <div class="row row-cols-1 row-cols-lg-3 g-6">
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body">
                                    <img src="imola-red-m3.jpg" class="card-img" alt="..."/><p></p>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body">
                                    <img src="sapphire-black-m3.jpeg" class="card-img" alt="..."/><p></p>
                        ...
                        <div class="col">
                            <div class="card h-100">
                                <div class="card-body">
                                    <img src="champagne-quartz.jpeg" class="card-img" alt="..."/><p></p>
